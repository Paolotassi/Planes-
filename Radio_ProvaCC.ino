...
while (!Serial.available()){}
  ...
  if (Data=="info"){
    ...
    Answer= "f0010301200400600300100001000000000020000000l";//stringa con telemetria. Questo è solo un esempio
    Serial.flush();
...
while(i<10){
  ...
  if (Data=="info"){
    //ricevi dati dall'aereo
    Answer= "f0010301200400600300100003000000000200000000l";//stringa con telemetria. Questo è solo un esempio
    Serial.flush();
    Serial.print(Answer);//affermativo, pronti
  }
...
while (!Serial.available()){}
  ...
  if (Data=="info"){
    //ricevi dati dall'aereo
    Answer= "f0010301200400600300100002000000000030000000l";//stringa con telemetria. Questo è solo un esempio
    Serial.flush();
    Serial.print(Answer);//affermativo, pronti
  }
 ...
 while (!Serial.available()){}
  ...
  if (Data=="info"){
    //ricevi dati dall'aereo
    Answer= "f00000000000000000000000000000000000000endedl";//stringa con telemetria. Questo è solo un esempio
    Serial.flush();
    Serial.print(Answer);//affermativo, pronti
  }
